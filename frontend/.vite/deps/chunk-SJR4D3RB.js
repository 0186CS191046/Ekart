...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React57 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState12 = React57.useState, useEffect12 = React57.useEffect, useLayoutEffect2 = React57.useLayoutEffect, useDebugValue2 = React57.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React57 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef26 = React57.useRef, useEffect12 = React57.useEffect, useMemo23 = React57.useMemo, useDebugValue2 = React57.useDebugValue;
...
var createSelectorMemoized = (...selectors3) => {
  const cache = /* @__PURE__ */ new WeakMap();
  let nextCacheId = 1;
  const combiner = selectors3[selectors3.length - 1];
  const nSelectors = selectors3.length - 1 || 1;
  ...
  const selector = (state, a1, a2, a3) => {
    ...
    if (!fn) {
      let reselectArgs = selectors3;
      const selectorArgs = [void 0, void 0, void 0];
      switch (argsLength) {
        case 0:
          break;
        case 1: {
          reselectArgs = [...selectors3.slice(0, -1), () => selectorArgs[0], combiner];
          break;
        }
        case 2: {
          reselectArgs = [...selectors3.slice(0, -1), () => selectorArgs[0], () => selectorArgs[1], combiner];
          break;
        }
        case 3: {
          reselectArgs = [...selectors3.slice(0, -1), () => selectorArgs[0], () => selectorArgs[1], () => selectorArgs[2], combiner];
          break;
        }
        default:
          throw new Error(true ? "Unsupported number of arguments" : formatErrorMessage_default(2));
...
var useFloatingParentNodeId = () => React9.useContext(FloatingNodeContext)?.id || null;
...
function useRole(context, props = {}) {
  ...
  const floatingId = React23.useMemo(() => getFloatingFocusElement(floatingElement)?.id || defaultFloatingId, [floatingElement, defaultFloatingId]);
...
//# sourceMappingURL=chunk-SJR4D3RB.js.map
