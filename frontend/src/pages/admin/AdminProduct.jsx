...
const AdminProducts = () => {
    ...
    const handleSave = async (e) => {
        ...
        try {
            const res = await axios.put(`http://localhost:8090/api/v1/product/${editProduct._id}`, formData, {
                headers: {
                                    ...
                                    <DialogContent className="sm:max-w-156.25 max-h-150 overflow-y-scroll">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                ...
                                                <div className="grid gap-2">
                                                    <Label>Brand</Label>
                                                    <Input type="text" value={editProduct?.brand} onChange={handleChange} placeholder="Ex-Apple" name="brand" required />
                                                </div>
                                            </div>
                                            <div className="grid gap-2">
